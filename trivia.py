...
questions = [
  ["What is Dwight Schrute's (The Office US) middle name?", "Kurt", 2, 2],
  ["How many bits are there per byte?", "8", 0, 0],
  ...
  ["Mario Kart 8 and Wii has 12 players or CPU's in a normal race. How many does Mario Kart 7 have?", "8", 2, 3],
  ["What year did the first Star Wars movie release (A new hope)?", "1977", 0, 2],
  ["Internet Movie Database (IMDb) is owned by what company?", "Amazon", 1, 2],
  ["What is the only unbreakable Minecraft block that is available in the creative inventory?", "bedrock", 0, 3],
